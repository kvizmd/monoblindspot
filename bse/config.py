...
_C.DATA.AUG = CfgNode()
_C.DATA.AUG.COLOR = 0.5
_C.DATA.AUG.H_FLIP = 0.5
_C.DATA.AUG.RESCALE_CROP = 0.5

_C.DATA.NAMES = []
_C.DATA.ROOT_DIRS = []
_C.DATA.TRAIN_SPLITS = []
_C.DATA.VAL_SPLITS = []
_C.DATA.TEST_SPLITS = []
_C.DATA.BS_LABELS = []
...
_C.TRAIN.REFERENCE_METRIC = 'long/f1'
...
_C.OGM.RANSAC_GOAL_INLIER_RATIO = 0.7
